...
//     setIsLoading(true);
//     try {
//       if(!title || !price || !imageAsset || !category || !calories)
//       {
//         setFields(true);
...
//           <input type="text" required value={title} placeholder='Give me a title...' onChange={(e) => setTitle(e.target.value)} className="w-full h-full text-lg bg-transparent outline-none border-none placeholder:text-gray-500 text-textColor" />
//         </div>
...
//                   <img src={imageAsset} className="w-full h-full object-cover" alt="upload image" />
...
//             <input type="text" required placeholder='Pirce' value={price}
//             onChange={(e)=>setPrice(e.target.value)} className='w-full h-full text-lg bg-transparent outline-none border-none placeholder:text-gray-400 text-textColor' />
//           </div>
//         </div>
